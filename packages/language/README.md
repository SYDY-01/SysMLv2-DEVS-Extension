...
- [src/sys-m-lv-2-extended.langium](src/sys-m-lv-2-extended.langium) -  The grammar definition of your language
- [src/sys-m-lv-2-extended-module.ts](src/sys-m-lv-2-extended-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/sys-m-lv-2-extended-validator.ts](src/sys-m-lv-2-extended-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/sys-m-lv-2-extended.monarch.ts](src/syntaxes/sys-m-lv-2-extended.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/sys-m-lv-2-extended.tmLanguage.json](syntaxes/sys-m-lv-2-extended.tmLanguage.json) - Textmate based syntax highlighting instructions.
